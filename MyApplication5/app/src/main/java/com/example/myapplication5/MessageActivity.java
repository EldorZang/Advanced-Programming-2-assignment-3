...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactServer = activityIntent.getStringExtra("contactServer");
        ...
        contactText = (TextView) findViewById(R.id.top_bar_user_name) ;
        contactText.setText(contactId);
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Retrofit retrofitTransfer = new Retrofit.Builder()
                        .baseUrl(validateUrl(contactServer))
                        .addConverterFactory(GsonConverterFactory.create())
                        .build();
                ContactsAPI serviceTransfer = retrofitTransfer.create(ContactsAPI.class);
                Call<Message> transferMessage = serviceTransfer.TransferMessage(new MessageTransfer(loggedUserId,contactId,msgText.getText().toString()));
                transferMessage.enqueue(new Callback<Message>() {
                    @Override
